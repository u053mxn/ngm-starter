...
import {CRUDStore} from '../../stores/stores/crud-store/crud-store';
...
export class DataTableComponent implements OnDestroy, OnChanges {
  ...
  getHelpText() {
    ...
    const pagingAndSortingInfo = 'Click the column headers to sort.' +
      'Change the "Items per page" dropdown underneath the results to view more results. ' +
