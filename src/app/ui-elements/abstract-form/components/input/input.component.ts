import {AfterViewInit, ChangeDetectionStrategy, Component, ElementRef, HostBinding, OnChanges, OnDestroy, OnInit, SimpleChanges, ViewChild, ViewEncapsulation} from '@angular/core';
