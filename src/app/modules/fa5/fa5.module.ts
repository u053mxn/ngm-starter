...
import {
    ...
    faEnvelope,
    faKey,
    faCar, faBed, faUserFriends, faLongArrowAltLeft, faDesktop, faChevronCircleRight, faPlaneArrival, faCalendarDay, faPlus, faBusAlt, faMoneyCheckAlt, faTaxi, faUtensils
...
export class Fa5Module {
    constructor() {
        library.add(faHome, faUser, faCreditCard, faUsers, faSearch, faEllipsisV, faPen, faTrash,
            faCcAmex, faCcDinersClub, faCcDiscover, faCcJcb, faCcMastercard, faCcVisa, faBars,
